...
<head>
    ...
    <title>Editing - {{ $note->title }}</title>
</head>
<body>
    <nav>
    ...
    <div class="container">
        ...
        <form action="{{ route('notes.update', $note) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input name="title" type="text" class="form-control" required value="{{ old('title', $note->title) }}">
            </div>
            <div class="mb-3">
                <label class="form-label">Content</label>
                <textarea name="content" class="form-control" rows="6">{{ old('content', $note->content) }}</textarea>
            </div>
